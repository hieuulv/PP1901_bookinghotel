...
@section('content')
    ...
    <div class="home">
        ...
        <div class="home_content">
            <div class="home_title">{{ __('the blog') }}</div>
        </div>
    </div>
            ...
            <div class="row">
                        ...
                        <div class="blog_post">
                            <div class="blog_post_image">
                                ...
                                <div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
                                    <div class="blog_post_day">{{ __('01') }}</div>
                                    <div class="blog_post_month">{{ __('Dec, 2017') }}</div>
                                </div>
                            </div>
                            <div class="blog_post_meta">
                                <ul>
                                    <li class="blog_post_meta_item"><a href="">{{ __('by Lore Papp') }}</a></li>
                                    <li class="blog_post_meta_item"><a href="">{{ __('Uncategorized') }}</a></li>
                                    <li class="blog_post_meta_item"><a href="">{{ __('3 Comments') }}</a></li>
                                </ul>
                            </div>
                            <div class="blog_post_title"><a href="#">{{ __('Try these new dream destinations') }}</a></div>
                            <div class="blog_post_text">
                                <p>
                                    {{ __('Aenean in lacus ligula. Phasellus euismod gravida eros. Aenean nec ipsum aliquet,
                                    pharetra magna id, interdum sapien. Etiam id lorem eu nisl pellentesque semper.
                                    Nullam tincidunt metus placerat, suscipit leo ut, tempus nulla. Fusce at eleifend
                                    tellus. Ut eleifend dui nunc, non fermentum qua.') }}
                                </p>
                            </div>
                            <div class="blog_post_link"><a href="#">{{ __('read more') }}</a></div>
                        </div>
                ...
                <div class="col-lg-4 sidebar_col">
                    ...
                    <div class="sidebar_archives">
                        <div class="sidebar_title">{{ __('Archives') }}</div>
                        <div class="sidebar_list">
                            <ul>
                                <li><a href="#">{{ __('March 2017') }}</a></li>
                                <li><a href="#">{{ __('April 2017') }}</a></li>
                                <li><a href="#">{{ __('May 2017') }}</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="sidebar_categories">
                        ...
                        <div class="sidebar_list">
                            <ul>
                                <li><a href="#">{{ __('Travel') }}</a></li>
                                <li><a href="#">{{ __('Exotic Destinations') }}</a></li>
                                <li><a href="#">{{ __('City Breaks') }}</a></li>
                                <li><a href="#">{{ __('Travel Tips') }}</a></li>
                                <li><a href="#">{{ __('Lifestyle & Travel') }}</a></li>
                                <li><a href="#">{{ __('City Breaks') }}</a></li>
                                <li><a href="#">{{ __('Uncategorized') }}</a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul>
                                ...
                                <li class="latest_post clearfix">
                                    ...
                                    <div class="latest_post_content">
                                        <div class="latest_post_title trans_200"><a href="#">{{ __('Tips to travel light') }}</a>
                                        </div>
                                        <div class="latest_post_meta">
                                            <div class="latest_post_author trans_200"><a href="#">{{ __('by Jane Smith') }}</a>
                                            </div>
                                            <div class="latest_post_date trans_200"><a href="#">{{ __('Aug 25, 2016') }}</a></div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="sidebar_gallery">
                        <div class="sidebar_title">{{ __('Instagram') }}</div>

...
@section('content')
    ...
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll">
            <img src="{{ asset('images/contact_background.jpg') }}" alt="">
        </div>
                    ...
                    <div class="contact_form_container">
                        ...
                        <form action="#" id="contact_form" class="contact_form text-center">
                            ...
                            <button type="submit" id="form_submit_button" class="form_submit_button button trans_200">
                                send message<span></span><span></span><span></span></button>
                        </form>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="about_content">
                        ...
                        <p class="about_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus quis vu
                            lputate eros, iaculis consequat nisl. Nunc et suscipit urna. Integer eleme ntum orci eu
                            vehicula iaculis consequat nisl. Nunc et suscipit urna pretium.</p>
